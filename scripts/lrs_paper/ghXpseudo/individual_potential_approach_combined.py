...
##### PSEUDO CONTROL  
si2 = pd.read_csv('/Volumes/lab-windingm/home/users/cochral/LRS/AttractionRig/analysis/social-isolation/pseudo-n10/group-housed/individual_approach_responses_2.csv')
si2['condition'] = 'Pseudo Control'
si2['response_distance'] = '2'

si3 = pd.read_csv('/Volumes/lab-windingm/home/users/cochral/LRS/AttractionRig/analysis/social-isolation/pseudo-n10/group-housed/individual_approach_responses_3.csv')
si3['condition'] = 'Pseudo Control'
si3['response_distance'] = '3'

si4 = pd.read_csv('/Volumes/lab-windingm/home/users/cochral/LRS/AttractionRig/analysis/social-isolation/pseudo-n10/group-housed/individual_approach_responses_4.csv')
si4['condition'] = 'Pseudo Control'
si4['response_distance'] = '4'

si5 = pd.read_csv('/Volumes/lab-windingm/home/users/cochral/LRS/AttractionRig/analysis/social-isolation/pseudo-n10/group-housed/individual_approach_responses_5.csv')
si5['condition'] = 'Pseudo Control'
si5['response_distance'] = '5'

si6 = pd.read_csv('/Volumes/lab-windingm/home/users/cochral/LRS/AttractionRig/analysis/social-isolation/pseudo-n10/group-housed/individual_approach_responses_6.csv')
si6['condition'] = 'Pseudo Control'
si6['response_distance'] = '6'

si7 = pd.read_csv('/Volumes/lab-windingm/home/users/cochral/LRS/AttractionRig/analysis/social-isolation/pseudo-n10/group-housed/individual_approach_responses_7.csv')
si7['condition'] = 'Pseudo Control'
si7['response_distance'] = '7'

si8 = pd.read_csv('/Volumes/lab-windingm/home/users/cochral/LRS/AttractionRig/analysis/social-isolation/pseudo-n10/group-housed/individual_approach_responses_8.csv')
si8['condition'] = 'Pseudo Control'
si8['response_distance'] = '8'

si9 = pd.read_csv('/Volumes/lab-windingm/home/users/cochral/LRS/AttractionRig/analysis/social-isolation/pseudo-n10/group-housed/individual_approach_responses_9.csv')
si9['condition'] = 'Pseudo Control'
si9['response_distance'] = '9'

si10 = pd.read_csv('/Volumes/lab-windingm/home/users/cochral/LRS/AttractionRig/analysis/social-isolation/pseudo-n10/group-housed/individual_approach_responses_10.csv')
...
df_all = df_all[df_all['dist_from_centre'] < 30]
...
plt.ylim(0, 1)
plt.tight_layout()
#plt.savefig('/Users/cochral/repos/behavioural-analysis/plots/lrs_paper/ghxpseudo/potential_interactions_individual_combined.pdf', format='pdf', bbox_inches='tight')
plt.show()
