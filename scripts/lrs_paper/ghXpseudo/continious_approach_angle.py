...
si = pd.read_csv('/Volumes/lab-windingm/home/users/cochral/LRS/AttractionRig/analysis/social-isolation/pseudo-n10/group-housed/individual_approach_responses_consistent_angle_10.csv')  
si['condition'] = 'Pseudo Control'
...
axes = axes.flatten()
combined["condition"] = pd.Categorical(combined["condition"], categories=HUE_ORDER, ordered=True)
...
plt.tight_layout()
plt.savefig('/Users/cochral/repos/behavioural-analysis/plots/lrs_paper/ghXpseudo/continious-approach-angle_speed-distance.pdf', format='pdf', bbox_inches='tight')
plt.show()
