...
for binned_angle in df['angle_bin'].dropna().unique():
    ...
    plt.savefig(f'/Users/cochral/repos/behavioural-analysis/plots/lrs_paper/GHxSI/approach_angle-{binned_angle.left:.0f}–{binned_angle.right:.0f}.pdf', format='pdf', bbox_inches='tight')
    plt.close()
