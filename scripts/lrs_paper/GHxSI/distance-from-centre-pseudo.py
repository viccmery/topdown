...
df1 = pd.read_csv('/Volumes/lab-windingm/home/users/cochral/LRS/AttractionRig/analysis/social-isolation/pseudo-n10/socially-isolated/distance_from_centre.csv')
...
plt.savefig('/Users/cochral/repos/behavioural-analysis/plots/lrs_paper/GHxSI/distance-from-centre-pseudo.pdf', format='pdf', bbox_inches='tight')
