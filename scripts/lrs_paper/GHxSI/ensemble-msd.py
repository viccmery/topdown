...
df2 = pd.read_csv('/Volumes/lab-windingm/home/users/cochral/LRS/AttractionRig/analysis/social-isolation/n10/socially-isolated/ensemble_msd.csv')
df2['condition'] = 'SI'
...
plt.savefig('/Users/cochral/repos/behavioural-analysis/plots/lrs_paper/GHxSI/ensemble-msd.pdf', format='pdf', bbox_inches='tight')
